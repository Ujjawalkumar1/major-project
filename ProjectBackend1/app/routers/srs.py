...
# Assuming SRS service runs on port 9000 based on user input
# User can override this via env var if needed, but defaults to localhost:9000
SRS_SERVICE_URL = os.getenv("SRS_SERVICE_URL", "http://127.0.0.1:9000/api/v1/generate/quick")
